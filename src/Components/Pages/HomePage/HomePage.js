            ...
            >
                ...
                <div className="audio_post_box">
                    ...
                    <h2 className="about-audio">
                        <p>
                            Send down the army, me and my friends during our
                            last retreat me and my friends during our last{" "}
                        </p>
                    </h2>
                    <div className="audio_navigations">
                        ...
                        <audio
                            className="audio"
                            src="./Audio/Panam parcy paul God of war.mp3"
                            controls
                            id="audio"
                        />
                ...
                <div className="posts_box">
                    ...
                    <div className="post_texts">
                        <p>
                            laurem ipsum dolor sit amet laurem ipsum dolor sit
                            ametlaurem ipsum dolor sit ametlaurem ipsum dolor
                            ametlaurem <br /> ipsum dolor sit amet! ametlaurem
                            ipsum dolor sit laurem ipsum dolor sit ametlaurem
                            ipsum dolor sit ametlaurem ipsum dolor ametlaurem
                            ipsum dolor sit amet! ametlaurem ipsum dolor sit
                            ametlaurem ipsum dolor sit amet!
                        </p>
                    </div>
